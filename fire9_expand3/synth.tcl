...
add_files -fileset constr expand3_fire9.xdc
...
synth_design -top [lindex [find_top] 0] -part xc7vx690t -constrset constr -quiet
...
report_utilization -file opt_utility.rpt
