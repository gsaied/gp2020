...
HD_PWD='/home/gsaied/Desktop/old_rtl/fire4_expand3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapper_rom.tcl
