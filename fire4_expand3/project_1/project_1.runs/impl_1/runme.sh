...
HD_PWD='/home/gsaied/Desktop/old_rtl/fire4_expand3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrapper_rom.tcl -notrace
