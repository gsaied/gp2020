...
set genomeRtd $env(RT_TMP)/7DD681F8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {rom_conv10_2__GB1}]"
...
set genomeName [subst -nocommands -novariables {rom_conv10_2__GB1}]
