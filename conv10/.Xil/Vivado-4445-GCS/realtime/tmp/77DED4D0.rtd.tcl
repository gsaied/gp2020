...
set genomeRtd $env(RT_TMP)/77DED4D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {conv10_1_2__GCB0}]"
...
set genomeName [subst -nocommands -novariables {conv10_1_2__GCB0}]
